...
def main():
	print "\n\n"
	print "**** Welome to page rank on hadoop  ****"
	print "\n\n"
	...
	os.system("sudo javac -cp /usr/lib/hadoop/*:/usr/lib/hadoop/client-0.20/* -d Index_classes Index.java PreProcess.java PageRankAnalysis.java SortPage.java MainDriver.java")
