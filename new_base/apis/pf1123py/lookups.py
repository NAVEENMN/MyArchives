...
add_params_list = ["mid","type","work","fid","from_email","ame","name", "email", "fb_id","images", "dev_id", "invites", "hosted", "joined","food_pref","movie_pref", "latitude", "longitude", "what", "gender"]
