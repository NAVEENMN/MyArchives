...
def test_in(op, pay):
	status = 1
        api_oper = [999000, 997008, 998000, 995001, 995002, 996000, 996001, 996002, 997006, 998001, 998002, 998103, 998104, 998105, 997000, 777555, 997666, 997667, 997668, 997670, 998100, 998101]
