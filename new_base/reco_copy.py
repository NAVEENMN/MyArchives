...
def main():
    ...
    # loop through the firebase and get host and memebers.
    ...
    '''
	yelp can handle boundry query but google cannot 
	so we need to define the circumference based on the memebers.
    '''
	...
	gn.rating = google_json[key]['ratings']
