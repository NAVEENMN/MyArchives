...
public class Accept_invite extends Activity {
	...
	public void create_firebase_event_refrence(String eventid){
				...
				strBuilder.append(commondata.facebook_details.facebook+"--"+commondata.facebook_details.name);//for that event add me
...
class logingcminback extends AsyncTask<Void, Void, Void>{
		...
		protected Void doInBackground(Void... params) {
        	...
        	fb.authorize(Accept_invite.this, new String[] {"email", "public_profile"}, new DialogListener(){
