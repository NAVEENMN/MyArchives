...
public class rotatecamera : MonoBehaviour {
	...
	void InitializeFirebase() {
		...
		DatabaseReference reference = FirebaseDatabase.DefaultInstance.GetReference("camera");
		...
		//set up listeners
		FirebaseDatabase.DefaultInstance.GetReference("camera").Child("xloc")
		...
		//set up listeners
		FirebaseDatabase.DefaultInstance.GetReference("camera").Child("yloc")
			.ValueChanged += (object sender2, ValueChangedEventArgs e2) => {
			if (e2.DatabaseError != null) {
				Debug.LogError(e2.DatabaseError.Message);
				return;
		...
		//set up listeners
		FirebaseDatabase.DefaultInstance.GetReference("camera").Child("zloc")
			.ValueChanged += (object sender2, ValueChangedEventArgs e2) => {
			if (e2.DatabaseError != null) {
				Debug.LogError(e2.DatabaseError.Message);
				return;
